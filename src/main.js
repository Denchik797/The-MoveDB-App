// импортирование библеотек и модулей 
...
// имортирование служебных компонентов 
...
const store = new Vuex.Store({
	state: {						// состояние
		nowplayings: {},			// новинки
		upcomings: {},				// ожидаемое 
		popularsMove: {},			// полпулярные
		getDetail: {},				// инфа О ФИЛЬМЕ
		getMovieTrailer: {},		// ТРЕЙЛЕР
		movieCast: {},				// актеры 
		person: {},					// инфа о актёре
		actorMovieBio: {},			// биография 
		searchresult: {},			// поиск
	},
	...
	// обращение к глабальным переменным из служебного компонен6та где мы полуем fetch 
