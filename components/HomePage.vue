		    	...
		    	<div v-if="detail">
		    		<div class="Title-Contanier">
						...
						<div class="Title-Contanier-Title">
		    				<h2>Добро пожаловать! Миллионы фильмов, сериалов и людей. Исследуйте сейчас.</h2>
		    			</div>
		    			<div class="search">
		     	...
		     	<div class="Now-playing">
		     	    <HomePageList :movies="nowplayings" title1="Идёт сейчас"></HomePageList>
		     	</div>
		     	<div class="upcoming">
		            <HomePageList :movies="upcomings" title2="Ожидается"></HomePageList>
		     	</div>
		     	<div class="popular">
		     	    <HomePageList :movies="popularsMove" title2="Популярные"></HomePageList>
		     	</div>
		     </div>
			</div>
		</div>
