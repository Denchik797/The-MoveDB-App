	...
	<div>
		...
		<div class="container">
				...
				<div class="movie-title">
					...
					<div class="relase">
						<div class="genres">
							...
							<h4>Время: {{movieDetail.runtime | movie_time}} /</h4>
							<h4>Жанр:</h4>
				...
				<div class="detail-poster">
					...
					<div class="trailer-button">
						<button @click="trailer = true">
							<img src="../img/multimedia.png" width="20">Смотреть трейлер
						</button>
					</div>
				</div>
			...
			<div class="detail-mid">
				...
				<h4 v-show="castdiv"> В этом фильме нет информации об актерах.</h4>
				...
				<div class="more-cast-button">
					<router-link :to="`/cast-crew/${id}`">
						<button v-show="castButton">Весь актерский состав и съемочная группа</button>
					</router-link>
				</div>
			</div>			
